...
sh process.sh -s -i Loose2016_v5.3.2 -t binning_and_sys -r phchang 
sh process.sh -s -i Loose2017_v5.3.2 -t binning_and_sys -r phchang 
sh process.sh -s -i Loose2018_v5.3.2 -t binning_and_sys -r phchang 
